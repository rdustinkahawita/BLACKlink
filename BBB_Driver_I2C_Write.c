...
#define S_FUNCTION_NAME BBB_Driver_I2C_Write
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          3
/* Input Port  0 */
#define IN_PORT_0_NAME      inI2C_W_Enable
...
/* Input Port  2 */
#define IN_PORT_2_NAME      inI2C_W_Trigger
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      outI2C_W_Data
...
{
    const boolean_T   *inI2C_W_Enable  = (const boolean_T*) ssGetInputPortSignal(S,0);
    const uint8_T   *inI2C_W_Value  = (const uint8_T*) ssGetInputPortSignal(S,1);
    const boolean_T   *inI2C_W_Trigger  = (const boolean_T*) ssGetInputPortSignal(S,2);
    uint8_T        *outI2C_W_Data  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    ...
    BBB_Driver_I2C_Write_Outputs_wrapper(inI2C_W_Enable, inI2C_W_Value, inI2C_W_Trigger, outI2C_W_Data, outSimStop, xD, prmI2C_BusNo, p_width0, prmI2C_DeviceAddress, p_width1, prmI2C_RegisterNo, p_width2, prmDebug_InfoLevel, p_width3);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    BBB_Driver_I2C_Write_Update_wrapper(inI2C_W_Enable, inI2C_W_Value, inI2C_W_Trigger, outI2C_W_Data, outSimStop,  xD, prmI2C_BusNo, p_width0, prmI2C_DeviceAddress, p_width1, prmI2C_RegisterNo, p_width2, prmDebug_InfoLevel, p_width3);
}
