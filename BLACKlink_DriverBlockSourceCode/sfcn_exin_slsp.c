...
#define S_FUNCTION_NAME sfcn_exin_slsp
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_exin_slsp_Outputs_wrapper(boolean_T *out ,
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sfcn_exin_slsp_Update_wrapper(const boolean_T *out ,
                           real_T *xD, 
                          const uint8_T  *pin, const int_T  p_width0);
...
{
    boolean_T        *out  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint8_T  *pin  = (const uint8_T *)mxGetData(PARAM_DEF0(S));

    sfcn_exin_slsp_Outputs_wrapper(out, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_exin_slsp_Update_wrapper(out,  xD, pin, p_width0);
}
