...
#define S_FUNCTION_NAME BBB_Driver_ADC_Read
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      inADC_Read_Enable
...
/* Input Port  1 */
#define IN_PORT_1_NAME      inADC_Read_Trigger
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      outADC_Voltage
...
#define NPARAMS              3
/* Parameter  1 */
#define PARAMETER_0_NAME      prmAINPin
...
{
    const boolean_T   *inADC_Read_Enable  = (const boolean_T*) ssGetInputPortSignal(S,0);
    const boolean_T   *inADC_Read_Trigger  = (const boolean_T*) ssGetInputPortSignal(S,1);
    uint32_T        *outADC_Voltage  = (uint32_T *)ssGetOutputPortRealSignal(S,0);
    ...
    const uint8_T  *prmAINPin  = (const uint8_T *)mxGetData(PARAM_DEF0(S));
    ...
    BBB_Driver_ADC_Read_Outputs_wrapper(inADC_Read_Enable, inADC_Read_Trigger, outADC_Voltage, outSimStop, xD, prmAINPin, p_width0, prmRunCalibration, p_width1, prmDebug_InfoLevel, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    BBB_Driver_ADC_Read_Update_wrapper(inADC_Read_Enable, inADC_Read_Trigger, outADC_Voltage, outSimStop,  xD, prmAINPin, p_width0, prmRunCalibration, p_width1, prmDebug_InfoLevel, p_width2);
}
