/*
  ...
  *   "Wrapper S-functions".
  *
  *   Created: Wed Jul 23 19:47:19 2014
  */
 ...
 *
 */
void BBB_Driver_Accelerometer_ADXL330_TSR1_Outputs_wrapper(real_T *X_Axis_Accel,
                          real_T *Y_Axis_Accel,
                          real_T *Z_Axis_Accel)
{
...
/*
float BBB_ACC_Val_X_SLink;
float BBB_ACC_Val_Y_SLink;
float BBB_ACC_Val_Z_SLink;
*/
...
float const BBB_ACC_Val_Y_Nominal=1666+(-0.126126*333);
float const BBB_ACC_Val_Z_Nominal=1666+((0.912013-1)*333);
    ...
    //{
        ...
        // Transfer Data to SLink Variable - For Output From SLink Block
        /*
        BBB_ACC_Val_X_SLink = BBB_ACC_Val_X;
        BBB_ACC_Val_Y_SLink = BBB_ACC_Val_Y;
        BBB_ACC_Val_Z_SLink = BBB_ACC_Val_Z;
        */
        // Close File on Exit
        fclose(BBB_Handle_X);
        fclose(BBB_Handle_Y);
        fclose(BBB_Handle_Z);
        /*
         //Transfer ADC Value to Output
        X_Axis_Accel[0]=BBB_ACC_Val_X_SLink;
        Y_Axis_Accel[0]=BBB_ACC_Val_Y_SLink;
        Z_Axis_Accel[0]=BBB_ACC_Val_Z_SLink;
        */
...
/*
    //Transfer ADC Value to Output
    X_Axis_Accel[0]=1; //BBB_ACC_Val_X_SLink;
    Y_Axis_Accel[0]=2; // BBB_ACC_Val_Y_SLink;
    Z_Axis_Accel[0]=3; // BBB_ACC_Val_Z_SLink;
*/
    /*
    X_Axis_Accel[0]=BBB_ACC_Val_X_SLink;
    Y_Axis_Accel[0]=BBB_ACC_Val_Y_SLink;
