 ...
 *
 */
void BBB_Driver_GPIO_Read_Outputs_wrapper(const boolean_T *inGPIO_Read_Enable,
...
int iBBB_GPIOExport(eGPIO_PinNo iGPIONo)
{
    ...
    if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO Export SYSFS Path: %s\n",sSYSFS_GPIO_Exp); }
    ...
    {
        // Error Handling
        if (iDebug_Level >=Debug_Level_1)  { printf("GPIORead Error: Failed Find/Open GPIO SYSFS Export File - Check GPIO Number/Device Tree\n"); }
        // Set Error Number
    ...
    // Ouput Program Flow
    if (iDebug_Level >=Debug_Level_3) {printf("GPIORead Msg: Program Flow State 2: Open GPIO SYSFS File\nError No: %i Error Level: %i\n",iError_No, iError_Level);}
    ...
    if (iError_No == Error_None)
    {
        ...
        // Check GPIO Bus Concatenation
        if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO No: %s\n",sBBB_GPIO_No); }
        ...
        {
            if (iDebug_Level >=Debug_Level_1) {printf("GPIORead Error: Failed to Export GPIO Number To User Space\n");}
            // Set Error Number
...
int iBBB_GPIOUnExport(eGPIO_PinNo iGPIONo)
{
    ...
    // Check GPIO Bus Concatenation
    if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO UnExport SYSFS Path: %s\n",sSYSFS_GPIO_UnExp); }
    ...
    {
        // Error Handling
        if (iDebug_Level >=Debug_Level_1)  { printf("GPIORead Error: Failed Find/Open GPIO UnExport SYSFS File - Check GPIO Number/Device Tree\n"); }
        // Set Error Number
        iError_No = Error_No_SYSFSOpen;
        // Set Error Level
        iError_Level = Error_Level_Critical;
    ...
    if (iError_No == Error_None)
    {
        ...
        if (iFILE_BBB_GPIO_Write_Handle<0)
        {
            if (iDebug_Level >=Debug_Level_1) {printf("GPIORead Error: Failed to UnExport GPIO Number To User Space\n");}
            // Set Error Number
            iError_No = Error_No_SYSFSWrite;
            // Set Error Level
            iError_Level = Error_Level_Critical;
...
int iBBB_GPIOSetDirection(eGPIO_PinNo iGPIONo, eGPIO_PinDirection iGPIODirection)
{
    ...
    // Check GPIO Bus Concatenation
    if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO Direction SYSFS Path: %s\n",sSYSFS_GPIO_Direction); }
    ...
    {
        // Error Handling
        if (iDebug_Level >=Debug_Level_1)  { printf("GPIORead Error: Failed Find/Open GPIO Direction SYSFS File - Check GPIO Number/Device Tree\n"); }
        // Set Error Number
        iError_No = Error_No_SYSFSOpen;
        // Set Error Level
        iError_Level = Error_Level_Critical;
    ...
    if (iError_No == Error_None)
    {
        ...
        if (iFILE_BBB_GPIO_Write_Handle<0)
        {
            if (iDebug_Level >=Debug_Level_1) {printf("GPIORead Error: Failed to Set GPIO In/Out Direction In User Space\n");}
            // Set Error Number
            iError_No = Error_No_SYSFSWrite;
            // Set Error Level
            iError_Level = Error_Level_Critical;
...
int iBBB_GPIORead(eGPIO_PinNo iGPIONo, unsigned int *iGPIOVal)
{
    ...
    // Check GPIO Bus Concatenation
    if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO Value SYSFS Path: %s\n",sSYSFS_GPIO_Value); }
    ...
    {
        // Error Handling
        if (iDebug_Level >=Debug_Level_1)  { printf("GPIORead Error: Failed Find/Open GPIO Value SYSFS File - Check GPIO Number/Device Tree\n"); }
        // Set Error Number
        iError_No = Error_No_SYSFSOpen;
        // Set Error Level
        iError_Level = Error_Level_Critical;
    ...
    if (iError_No == Error_None)
    {
        ...
        iFILE_BBB_GPIO_Read_Handle=read(iFILE_BBB_GPIO_Open_Handle,&cSYSFS_GPIO_ReadVal,sizeof(&cSYSFS_GPIO_ReadVal));
         ...
         // Check GPIO Bus Concatenation
        if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO Value Read: %s\n",&cSYSFS_GPIO_ReadVal); }
        ...
        {
            if (iDebug_Level >=Debug_Level_1) {printf("GPIORead Error: Failed to Read GPIO Value In User Space\n");}
            // Set Error Number
...
int iBBB_GPIOWrite(eGPIO_PinNo iGPIONo, eGPIO_PinValue iGPIOVal)
{
    ...
    // Check GPIO Bus Concatenation
    if (iDebug_Level >=Debug_Level_2)  { printf("GPIORead Msg: GPIO Write SYSFS Path: %s\n",sSYSFS_GPIO_Value); }
    ...
    if (iError_No == Error_None)
    {
        ...
        if (iFILE_BBB_GPIO_Write_Handle<0)
        {
            if (iDebug_Level >=Debug_Level_1) {printf("GPIORead Error: Failed to Write GPIO Value In User Space\n");}
            // Set Error Number
            iError_No = Error_No_SYSFSWrite;
            // Set Error Level
            iError_Level = Error_Level_Critical;
...
// Start Line
if (iDebug_Level >=Debug_Level_0){printf("**** Start of GPIO Read S-Function Block Execution **** \n");}
...
// Check For Critical Errors and Stop Simulation
    ...
    // Print Output
    if (iDebug_Level >=Debug_Level_0){printf("Data From GPIO: %d  Output: %d\n",iGPIO_ReadValue,outGPIO_ReadValue[0]);}
