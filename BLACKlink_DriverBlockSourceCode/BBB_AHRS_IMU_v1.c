...
#define S_FUNCTION_NAME BBB_AHRS_IMU_v1
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void BBB_AHRS_IMU_v1_Outputs_wrapper(const real_T *inGyro_w_x,
                          ...
                          const real_T  *xD);
extern void BBB_AHRS_IMU_v1_Update_wrapper(const real_T *inGyro_w_x,
                          const real_T *inGyro_w_y,
                          const real_T *inGyro_w_z,
                          const real_T *inAccel_a_x,
                          const real_T *inAccel_a_y,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    BBB_AHRS_IMU_v1_Outputs_wrapper(inGyro_w_x, inGyro_w_y, inGyro_w_z, inAccel_a_x, inAccel_a_y, inAccel_a_z, outQuat_q_1, outQuat_q_2, outQuat_q_3, outQuat_q_4, outStopSim, xD);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    BBB_AHRS_IMU_v1_Update_wrapper(inGyro_w_x, inGyro_w_y, inGyro_w_z, inAccel_a_x, inAccel_a_y, inAccel_a_z, outQuat_q_1, outQuat_q_2, outQuat_q_3, outQuat_q_4, outStopSim,  xD);
}
