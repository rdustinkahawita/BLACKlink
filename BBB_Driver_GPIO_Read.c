...
#define S_FUNCTION_NAME BBB_Driver_GPIO_Read
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      inGPIO_Read_Enable
...
/* Input Port  1 */
#define IN_PORT_1_NAME      inGPIO_Read
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      outGPIO_ReadValue
...
{
    const boolean_T   *inGPIO_Read_Enable  = (const boolean_T*) ssGetInputPortSignal(S,0);
    const boolean_T   *inGPIO_Read  = (const boolean_T*) ssGetInputPortSignal(S,1);
    boolean_T        *outGPIO_ReadValue  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    ...
    BBB_Driver_GPIO_Read_Outputs_wrapper(inGPIO_Read_Enable, inGPIO_Read, outGPIO_ReadValue, outSimStop, prmGPIO_No, p_width0, prmDebug_InfoLevel, p_width1);
}
